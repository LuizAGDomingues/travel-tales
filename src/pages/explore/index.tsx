      ...
      <main>
        ...
        <section className='flex flex-col items-center justify-center w-full mt-[20rem]'>
          ...
          <div className='flex flex-wrap mb-10 items-center justify-center gap-5'>
            <ExploreButtons.IconEnd icon={<ParkIcon sx={{ color: '#0F9D58', width: '32px', height: '32px' }}/>} text='Write nearest park spot' />
            <ExploreButtons.IconEnd icon={<WaterIcon sx={{ color: '#4285F4', width: '32px', height: '32px' }}/>} text='Write nearest lagoon spot' />
            ...
            <ExploreButtons.IconEnd icon={<LocalBarIcon sx={{ color: '#000', width: '32px', height: '32px' }}/>} text='Write nearest club spot' />
