...
interface ExploreButtonProps extends ButtonHTMLAttributes<HTMLButtonElement> {
  icon: ReactNode
  text: string
}

function ExploreButtonsIconStart({ icon, text }: ExploreButtonProps, {...props}) {
  return (
    <Button 
      {...props}
      variant="outlined"
...
function ExploreButtonsIconEnd({ icon, text }: ExploreButtonProps, {...props}) {
  return (
    <Button 
      variant="outlined"
      endIcon={icon}
...
interface ExploreButtonsIconBoth extends ButtonHTMLAttributes<HTMLButtonElement> {
  iconStart: ReactNode
  iconEnd: ReactNode
  text: string
  link?: string
...
function ExploreButtonsIconBoth({ iconStart, iconEnd, text, className, link = '' }: ExploreButtonsIconBoth, {...props}) {
  return (
    <Button 
      variant="outlined"
      href={link}
