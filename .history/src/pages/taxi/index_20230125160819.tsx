    ...
    <>
      ...
      <main>
        ...
        <section className='flex flex-col items-center justify-center w-full mt-[17rem]'>
          <Text title text='Cab' />
          <ExploreButtons.IconStart icon={<NavigationIcon sx={{ color: '#1A73E8', width: '30px', height: '30px' }}/>} text='Taxis and Cars' />
          <ExploreButtons.IconBoth 
            iconStart={<HailIcon sx={{ width: '40px', height: '40px', marginRight: '5px' }}/>} 
          ...
          />
          <ExploreButtons.IconBoth 
            iconStart={<LocalTaxiIcon sx={{ width: '40px', height: '40px', marginRight: '5px' }}/>} 
            iconEnd={<ArrowRightIcon sx={{ width: '30px', height: '30px' }}/>} 
          ...
          />
          <ExploreButtons.IconBoth 
            iconStart={<TwoWheelerIcon sx={{ width: '40px', height: '40px', marginRight: '5px' }}/>} 
            iconEnd={<ArrowRightIcon sx={{ width: '30px', height: '30px' }}/>} 
