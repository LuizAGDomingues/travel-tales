...
export async function getServerSideProps(userLatitude: string, userLatitude: string) {
...
export default function Home({ nearbyPark, nearbyMuseum, nearbyShopping, nearbyRestaurant }: InferGetServerSidePropsType<typeof getServerSideProps>) {
  ...
  getServerSideProps(userLatitude, userLongitude)
