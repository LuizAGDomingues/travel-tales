      ...
      <main>
        ...
        <section className='flex flex-col items-center justify-center w-full mt-[20rem]'>
          ...
          <div className='flex flex-wrap mb-10 items-center justify-center gap-5'>
            ...
            <ExploreButtons.IconEnd icon={<ShoppingBagIcon sx={{ color: '#000', width: '32px', height: '32px' }}/>} text={closestShopping.name} />
            <ExploreButtons.IconEnd icon={<LocalDiningIcon sx={{ color: '#000', width: '32px', height: '32px' }}/>} text={closestRestaurant.name} />
          </div>
        </section>
      </main>
    </>
