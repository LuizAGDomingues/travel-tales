...
export async function getServerSideProps() {
  ...
  const [nearbyPark, nearbyMuseum, nearbyShopping, nearbyRestaurant] = await Promise.all([
    getNearbyPlaces(latitude, userLongitude, 'park'),
    getNearbyPlaces(latitude, userLongitude, 'museum'),
    getNearbyPlaces(latitude, userLongitude, 'shopping'),
    getNearbyPlaces(latitude, userLongitude, 'restaurant')
  ])
