...
export default function Home() {
  ...
  useEffect(() => {
    async function nearbyLocations() {
      const [nearbyPark, nearbyMuseum, nearbyShopping, nearbyRestaurant]: any = await Promise.all([
        getNearbyPlaces(userLatitude, userLongitude, 'park'),
        getNearbyPlaces(userLatitude, userLongitude, 'museum'),
        getNearbyPlaces(userLatitude, userLongitude, 'store'),
    ...
    if(userLatitude != undefined && userLatitude != '' && userLongitude != undefined && userLongitude != ''){
      nearbyLocations()
    }
      ...
      <main>
        ...
        <section className='flex flex-col items-center justify-center w-full mt-[20rem]'>
          ...
          <div className='flex flex-wrap mb-10 items-center justify-center gap-5'>
            <ExploreButtons.IconEnd onClick={handleClickPark} icon={isLoading ? <CircularProgress />} text={closestPark.name} />
