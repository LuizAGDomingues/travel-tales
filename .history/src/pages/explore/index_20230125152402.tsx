...
export default function Home() {
  ...
  const [closestMuseum, setClosestPark] = useState({name: '', lat: '', lng: ''})
  const [closestShopping, setClosestPark] = useState({name: '', lat: '', lng: ''})
  const [closestRestaurant, setClosestPark] = useState({name: '', lat: '', lng: ''})
