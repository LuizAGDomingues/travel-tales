  ...
  useEffect(() => {
    async function nearbyLocations() {
      const [nearbyPark, nearbyMuseum, nearbyShopping, nearbyRestaurant] = await Promise.all([
        getNearbyPlaces(userLatitude, userLongitude, 'park').catch(error => console.log(error)),
        getNearbyPlaces(userLatitude, userLongitude, 'museum').catch(error => console.log(error)),
        getNearbyPlaces(userLatitude, userLongitude, 'shop').catch(error => console.log(error)),
        getNearbyPlaces(userLatitude, userLongitude, 'restaurant').catch(error => console.log(error))
      ])
