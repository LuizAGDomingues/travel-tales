...
export default function Home() {
  ...
  useEffect(() => {
    ...
    async function getAdress(userLatitude: string, userLongitude: number) {
      const locationInfo = await getLocationInfo(userLatitude.toString(), userLongitude.toString());
      console.log(locationInfo);
    }
    getAdress(userLatitude!, userLongitude!)
  }, [])
