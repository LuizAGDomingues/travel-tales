...
export default function Home() {
  ...
  useEffect(() => {
    if (
      searchLatitude?.trim() === '' ||
      (searchLatitude === undefined && searchLongitude?.trim() === '') ||
      ...
      <main>
        ...
        <section className="flex flex-col items-center justify-center w-full mt-[17rem]">
          ...
          <div className="flex items-center justify-center gap-11 mt-16">
            ...
            <div
              className="flex flex-col px-7 py-3 rounded-xl w-[24rem]"
              style={{ boxShadow: '0px 0px 10px rgba(0, 0, 0, 0.5)' }}
            >
              <Text
                text="Adress"
                className="underline decoration-[#1A73E8] mb-6 text-center"
              />
              <Text text={`Location: ${userLocation}`} className="mb-4" />
            </div>
          </div>
        </section>
      </main>
